Shader "InFalsusStudio/VertexOpaque"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings i) : SV_Target {
                ...
                half4 color=i.color; color.rgb = lerp(color.rgb, _FogColor.rgb, fog); return color;
            }
            ENDHLSL
        }
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings i):SV_Target {float fog=smoothstep(_FogStart,max(_FogStart+0.01,_FogEnd),i.worldZ);half4 color=i.color;color.rgb = lerp(color.rgb, _FogColor.rgb, fog); return color;}
            ENDCG
        }
    }
}
